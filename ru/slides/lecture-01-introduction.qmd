...
$$
P_{\mathrm{freq}}(\text{орёл})=\hat p=\frac{k}{n},
$$
...
1. Посчитайте обе вероятности для случая
$$
n=2,\qquad k=1.
$$

2. Посчитайте обе вероятности для случая
$$
n=1,\qquad k=1.
$$
...
Для $n=2,\;k=1$ обе вероятности равны $1/2$.
Для $n=1,\;k=1$ ответы уже разные.
</div>
:::